...
namespace HTMLGeneratorMVC.Areas.User.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public ActionResult DeleteAccount()
        {
            ...
            if (User.IsInRole("Admin"))
                return RedirectToAction("DeleteAccount", "Manage", new { area = "Admin" });
            return View(user);
        }
        ...
        public async Task<ActionResult> DeleteConfirmed()
        {
            ...
            var stylesOfUser = db.Styles.Where(x => x.UserId == userModel.Id);
        ...
        {
            if (User.IsInRole("Admin"))
                return RedirectToAction("ChangePassword", "Manage", new { area = "Admin" });
            return View();
        }
