...
namespace HTMLGeneratorMVC.Areas.Admin.Controllers
{
    ...
    public class CategoryController : Controller
    {
        ...
        public ActionResult RenameStyles(int? id)
        {
            ...
            if (User.IsInRole("User"))
                return RedirectToAction("RenameStyles", "Category", new { area = "User" });
            return View(style);
        }
        ...
        public ActionResult RenameColors(int? id)
        {
            ...
            if (User.IsInRole("User"))
                return RedirectToAction("RenameColors", "Category", new { area = "User" });
            return View(style);
        }
        ...
        public ActionResult RenameTables(int? id)
        {
            ...
            if (User.IsInRole("User"))
                return RedirectToAction("RenameTables", "Category", new { area = "User" });
            return View(style);
        }
        ...
        public ActionResult RenameFormatting(int? id)
        {
            ...
            if (User.IsInRole("User"))
                return RedirectToAction("RenameFormatting", "Category", new { area = "User" });
            return View(style);
        }
        ...
        public ActionResult RenameButtons(int? id)
        {
            ...
            if (User.IsInRole("User"))
                return RedirectToAction("RenameButtons", "Category", new { area = "User" });
            return View(style);
        }
        ...
        public ActionResult RenameLinks(int? id)
        {
            ...
            if (User.IsInRole("User"))
                return RedirectToAction("RenameLinks", "Category", new { area = "User" });
            return View(style);
        }
        ...
        public ActionResult RenameImages(int? id)
        {
            ...
            if (User.IsInRole("User"))
                return RedirectToAction("RenameImages", "Category", new { area = "User" });
            return View(style);
        }
        ...
        public ActionResult RenameHeadings(int? id)
        {
            ...
            if (User.IsInRole("User"))
                return RedirectToAction("RenameHeadings", "Category", new { area = "User" });
            return View(style);
        }
        ...
        public ActionResult RenameParagraphs(int? id)
        {
            ...
            if (User.IsInRole("User"))
                return RedirectToAction("RenameParagraphs", "Category", new { area = "User" });
            return View(style);
        }
        ...
        public ActionResult RenameUnorderedList(int? id)
        {
            ...
            if (User.IsInRole("User"))
                return RedirectToAction("RenameUnorderedList", "Category", new { area = "User" });
            return View(style);
        }
        ...
        public ActionResult RenameOrderedList(int? id)
        {
            ...
            if (User.IsInRole("User"))
                return RedirectToAction("RenameOrderedList", "Category", new { area = "User" });
            return View(style);
        }
        ...
        public ActionResult RenameHeader(int? id)
        {
            ...
            if (User.IsInRole("User"))
                return RedirectToAction("RenameHeader", "Category", new { area = "User" });
            return View(style);
        }
        ...
        public ActionResult RenameNavigation(int? id)
        {
            ...
            if (User.IsInRole("User"))
                return RedirectToAction("RenameNavigation", "Category", new { area = "User" });
            return View(style);
        }
        ...
        public ActionResult RenameMain(int? id)
        {
            ...
            if (User.IsInRole("User"))
                return RedirectToAction("RenameMain", "Category", new { area = "User" });
            return View(style);
        }
        ...
        public ActionResult RenameFooter(int? id)
        {
            ...
            if (User.IsInRole("User"))
                return RedirectToAction("RenameFooter", "Category", new { area = "User" });
            return View(style);
        }
