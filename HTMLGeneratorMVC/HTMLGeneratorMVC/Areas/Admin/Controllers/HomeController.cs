...
namespace HTMLGeneratorMVC.Areas.Admin.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public ActionResult Styles(int? id)
        {
            ...
            {
                var item1 = db.Styles.Where(u => u.UserId == item.Id).Where(x => x.Category.Contains("Styles")).Count();
                if (item1 < 5)
                {
                    myListCount.Add(item1);
                }
                break;
            }
            if (myListCount.Count() != 0)
            {
                ViewBag.MyListCount = myListCount.Count();
            }
            else
            {
                ViewBag.MyListCount = null;
            }
            List<int> myList = new List<int>();
            foreach (var item in db.Users.ToList())
            {
                myList.Add(db.Styles.Where(x => x.UserId == item.Id).Where(c => c.Category == "Styles").Count());
            }
            ViewBag.MyListCount = myList.ToList();
            ...
            if (User.IsInRole("User"))
                return RedirectToAction("Styles", "Home", new { area = "User" });
            return View();
        }
            ...
            string ParagraphText, string ParagraphTextColor)
        {
            ...
            List<Tuple<int, string, int>> myList = new List<Tuple<int, string, int>>();
            foreach (var item in db.Users.ToList())
            {
                myList.Add(Tuple.Create(item.Id, item.Email, db.Styles.Where(x => x.UserId == item.Id).Where(c => c.Category == "Styles").Count()));
            }
            ViewBag.MyList = myList.ToList();
        ...
        public ActionResult Styles(Style style, string user)
        {
            ...
            if (Session["backUserId"] == null)
            {
                ...
                {
                    int User = int.Parse(user);
                    int userId = db.Users.Where(x => x.Id == User).FirstOrDefault().Id;
                    style.UserId = userId;
                }
                else
                {
        ...
        public ActionResult Colors(int? id)
        {
            ...
            foreach (var item in db.Users.ToList())
            {
                myList.Add(db.Styles.Where(x => x.UserId == item.Id).Where(c => c.Category == "Colors").Count());
            }
            ViewBag.MyListCount = myList.ToList();
            ...
            if (User.IsInRole("User"))
                return RedirectToAction("Colors", "Home", new { area = "User" });
            return View();
        }
        ...
        public ActionResult _PartialColors(string color)
        {
            ...
            foreach (var item in db.Users.ToList())
            {
                myList.Add(Tuple.Create(item.Id, item.Email, db.Styles.Where(x => x.UserId == item.Id).Where(c => c.Category == "Colors").Count()));
            }
            ViewBag.MyList = myList.ToList();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Colors(Style style, string user)
        {
            if (string.IsNullOrEmpty(style.Title))
            {
        ...
        public ActionResult Tables(int? id)
        {
            ...
            foreach (var item in db.Users.ToList())
            {
                myList.Add(db.Styles.Where(x => x.UserId == item.Id).Where(c => c.Category == "Tables").Count());
            }
            ViewBag.MyListCount = myList.ToList();
            ...
            if (User.IsInRole("User"))
                return RedirectToAction("Tables", "Home", new { area = "User" });
            return View();
        }
        ...
        string BorderStyle)
        {
            ...
            foreach (var item in db.Users.ToList())
            {
                myList.Add(Tuple.Create(item.Id, item.Email, db.Styles.Where(x => x.UserId == item.Id).Where(c => c.Category == "Tables").Count()));
            }
            ViewBag.MyList = myList.ToList();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Tables(Style style, string user)
        {
            if (string.IsNullOrEmpty(style.Title))
            {
        ...
        public ActionResult Formatting(int? id)
        {
            ...
            foreach (var item in db.Users.ToList())
            {
                myList.Add(db.Styles.Where(x => x.UserId == item.Id).Where(c => c.Category == "Formatting").Count());
            }
            ViewBag.MyListCount = myList.ToList();
            ...
            if (User.IsInRole("User"))
                return RedirectToAction("Formatting", "Home", new { area = "User" });
            return View();
        }
        ...
        public ActionResult _PartialFormatting(string FormatText, string Format)
        {
            ...
            foreach (var item in db.Users.ToList())
            {
                myList.Add(Tuple.Create(item.Id, item.Email, db.Styles.Where(x => x.UserId == item.Id).Where(c => c.Category == "Formatting").Count()));
            }
            ViewBag.MyList = myList.ToList();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Formatting(Style style, string user)
        {
            if (string.IsNullOrEmpty(style.Title))
            {
        ...
        public ActionResult Buttons(int? id)
        {
            ...
            foreach (var item in db.Users.ToList())
            {
                myList.Add(db.Styles.Where(x => x.UserId == item.Id).Where(c => c.Category == "Buttons").Count());
            }
            ViewBag.MyListCount = myList.ToList();
            ...
            if (User.IsInRole("User"))
                return RedirectToAction("Buttons", "Home", new { area = "User" });
            return View();
        }
        ...
        public ActionResult _PartialButtons(string PickButtonType, string ButtonText, string ButtonName, string ButtonTarget)
        {
            ...
            foreach (var item in db.Users.ToList())
            {
                myList.Add(Tuple.Create(item.Id, item.Email, db.Styles.Where(x => x.UserId == item.Id).Where(c => c.Category == "Buttons").Count()));
            }
            ViewBag.MyList = myList.ToList();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Buttons(Style style, string user)
        {
            if (string.IsNullOrEmpty(style.Title))
            {
        ...
        public ActionResult Links(int? id)
        {
            ...
            foreach (var item in db.Users.ToList())
            {
                myList.Add(db.Styles.Where(x => x.UserId == item.Id).Where(c => c.Category == "Links").Count());
            }
            ViewBag.MyListCount = myList.ToList();
            ...
            if (User.IsInRole("User"))
                return RedirectToAction("Links", "Home", new { area = "User" });
            return View();
        }
        ...
        public ActionResult _PartialLinks(string LinkText, string LinkHref, string linkTarget)
        {
            ...
            foreach (var item in db.Users.ToList())
            {
                myList.Add(Tuple.Create(item.Id, item.Email, db.Styles.Where(x => x.UserId == item.Id).Where(c => c.Category == "Links").Count()));
            }
            ViewBag.MyList = myList.ToList();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Links(Style style, string user)
        {
            if (string.IsNullOrEmpty(style.Title))
            {
        ...
        public ActionResult Images(int? id)
        {
            ...
            foreach (var item in db.Users.ToList())
            {
                myList.Add(db.Styles.Where(x => x.UserId == item.Id).Where(c => c.Category == "Images").Count());
            }
            ViewBag.MyListCount = myList.ToList();
            ...
            if (User.IsInRole("User"))
                return RedirectToAction("Images", "Home", new { area = "User" });
            return View();
        }
        ...
        public ActionResult _PartialImages(string ImageSource, string ImageAlt, string ImageWidth, string ImageHeight)
        {
            ...
            foreach (var item in db.Users.ToList())
            {
                myList.Add(Tuple.Create(item.Id, item.Email, db.Styles.Where(x => x.UserId == item.Id).Where(c => c.Category == "Images").Count()));
            }
            ViewBag.MyList = myList.ToList();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Images(Style style, string user)
        {
            if (string.IsNullOrEmpty(style.Title))
            {
        ...
        public ActionResult Headings(int? id)
        {
            ...
            foreach (var item in db.Users.ToList())
            {
                myList.Add(db.Styles.Where(x => x.UserId == item.Id).Where(c => c.Category == "Headings").Count());
            }
            ViewBag.MyListCount = myList.ToList();
            ...
            if (User.IsInRole("User"))
                return RedirectToAction("Headings", "Home", new { area = "User" });
            return View();
        }
        ...
        public ActionResult _PartialHeadings(string HeadingText, string Heading)
        {
            ...
            foreach (var item in db.Users.ToList())
            {
                myList.Add(Tuple.Create(item.Id, item.Email, db.Styles.Where(x => x.UserId == item.Id).Where(c => c.Category == "Headings").Count()));
            }
            ViewBag.MyList = myList.ToList();
            TempData["HeadingText"] = HeadingText;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Headings(Style style, string user)
        {
            if (string.IsNullOrEmpty(style.Title))
            {
        ...
        public ActionResult Paragraphs(int? id)
        {
            ...
            foreach (var item in db.Users.ToList())
            {
                myList.Add(db.Styles.Where(x => x.UserId == item.Id).Where(c => c.Category == "Paragraphs").Count());
            }
            ViewBag.MyListCount = myList.ToList();
            ...
            if (User.IsInRole("User"))
                return RedirectToAction("Paragraphs", "Home", new { area = "User" });
            return View();
        }
        ...
        public ActionResult _PartialParagraphs(string ParagraphText, string ParagraphStyle)
        {
            ...
            foreach (var item in db.Users.ToList())
            {
                myList.Add(Tuple.Create(item.Id, item.Email, db.Styles.Where(x => x.UserId == item.Id).Where(c => c.Category == "Paragraphs").Count()));
            }
            ViewBag.MyList = myList.ToList();
            TempData["ParagraphText"] = ParagraphText;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Paragraphs(Style style, string user)
        {
            if (string.IsNullOrEmpty(style.Title))
            {
        ...
        public ActionResult UnorderedList(int? id)
        {
            ...
            foreach (var item in db.Users.ToList())
            {
                myList.Add(db.Styles.Where(x => x.UserId == item.Id).Where(c => c.Category == "UnorderedList").Count());
            }
            ViewBag.MyListCount = myList.ToList();
            ...
            if (User.IsInRole("User"))
                return RedirectToAction("UnorderedList", "Home", new { area = "User" });
            return View();
        }
        ...
        public ActionResult _PartialUnorderedList(string ListText, string UlstyleType)
        {
            ...
            foreach (var item in db.Users.ToList())
            {
                myList.Add(Tuple.Create(item.Id, item.Email, db.Styles.Where(x => x.UserId == item.Id).Where(c => c.Category == "UnorderedList").Count()));
            }
            ViewBag.MyList = myList.ToList();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult UnorderedList(Style style, string user)
        {
            if (string.IsNullOrEmpty(style.Title))
            {
        ...
        public ActionResult OrderedList(int? id)
        {
            ...
            foreach (var item in db.Users.ToList())
            {
                myList.Add(db.Styles.Where(x => x.UserId == item.Id).Where(c => c.Category == "OrderedList").Count());
            }
            ViewBag.MyListCount = myList.ToList();
            ...
            if (User.IsInRole("User"))
                return RedirectToAction("OrderedList", "Home", new { area = "User" });
            return View();
        }
        ...
        public ActionResult _PartialOrderedList(string ListText, string OlstyleType)
        {
            ...
            foreach (var item in db.Users.ToList())
            {
                myList.Add(Tuple.Create(item.Id, item.Email, db.Styles.Where(x => x.UserId == item.Id).Where(c => c.Category == "OrderedList").Count()));
            }
            ViewBag.MyList = myList.ToList();
            TempData["ListText"] = ListText;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult OrderedList(Style style, string user)
        {
            if (string.IsNullOrEmpty(style.Title))
            {
        ...
        public ActionResult Header(int? id)
        {
            ...
            foreach (var item in db.Users.ToList())
            {
                myList.Add(db.Styles.Where(x => x.UserId == item.Id).Where(c => c.Category == "Header").Count());
            }
            ViewBag.MyListCount = myList.ToList();
            ...
            if (User.IsInRole("User"))
                return RedirectToAction("Header", "Home", new { area = "User" });
            return View();
        }
        ...
        public ActionResult _PartialHeader(string HeaderText, string PickHeaderColor)
        {
            ...
            foreach (var item in db.Users.ToList())
            {
                myList.Add(Tuple.Create(item.Id, item.Email, db.Styles.Where(x => x.UserId == item.Id).Where(c => c.Category == "Header").Count()));
            }
            ViewBag.MyList = myList.ToList();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Header(Style style, string user)
        {
            if (string.IsNullOrEmpty(style.Title))
            {
        ...
        public ActionResult Navigation(int? id)
        {
            ...
            foreach (var item in db.Users.ToList())
            {
                myList.Add(db.Styles.Where(x => x.UserId == item.Id).Where(c => c.Category == "Navigation").Count());
            }
            ViewBag.MyListCount = myList.ToList();
            ...
            if (User.IsInRole("User"))
                return RedirectToAction("Navigation", "Home", new { area = "User" });
            return View();
        }
        ...
        public ActionResult _PartialNavigation(string NavText, string PickNavColor, string PickNavHoverColor)
        {
            ...
            foreach (var item in db.Users.ToList())
            {
                myList.Add(Tuple.Create(item.Id, item.Email, db.Styles.Where(x => x.UserId == item.Id).Where(c => c.Category == "Navigation").Count()));
            }
            ViewBag.MyList = myList.ToList();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Navigation(Style style, string user)
        {
            if (string.IsNullOrEmpty(style.Title))
            {
        ...
        public ActionResult Main(int? id)
        {
            ...
            foreach (var item in db.Users.ToList())
            {
                myList.Add(db.Styles.Where(x => x.UserId == item.Id).Where(c => c.Category == "Main").Count());
            }
            ViewBag.MyListCount = myList.ToList();
            ...
            if (User.IsInRole("User"))
                return RedirectToAction("Main", "Home", new { area = "User" });
            return View();
        }
        ...
        public ActionResult _PartialMain(string SectionText, string ArticleText, string AsideText)
        {
            ...
            foreach (var item in db.Users.ToList())
            {
                myList.Add(Tuple.Create(item.Id, item.Email, db.Styles.Where(x => x.UserId == item.Id).Where(c => c.Category == "Main").Count()));
            }
            ViewBag.MyList = myList.ToList();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Main(Style style, string user)
        {
            if (string.IsNullOrEmpty(style.Title))
            {
        ...
        public ActionResult Footer(int? id)
        {
            ...
            foreach (var item in db.Users.ToList())
            {
                myList.Add(db.Styles.Where(x => x.UserId == item.Id).Where(c => c.Category == "Footer").Count());
            }
            ViewBag.MyListCount = myList.ToList();
            ...
            if (User.IsInRole("User"))
                return RedirectToAction("Footer", "Home", new { area = "User" });
            return View();
        }
        ...
        public ActionResult _PartialFooter(string FooterText, string FooterColor)
        {
            ...
            foreach (var item in db.Users.ToList())
            {
                myList.Add(Tuple.Create(item.Id, item.Email, db.Styles.Where(x => x.UserId == item.Id).Where(c => c.Category == "Footer").Count()));
            }
            ViewBag.MyList = myList.ToList();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Footer(Style style, string user)
        {
            if (string.IsNullOrEmpty(style.Title))
            {
